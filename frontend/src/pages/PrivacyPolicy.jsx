  ...
  return (
    <div className="bg-gray-50 dark:bg-neutral-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-8">
        ...
        <p className="text-sm text-gray-600 dark:text-neutral-400 mb-8">
          <strong>Última actualización:</strong> 6 de noviembre de 2025<br />
          <strong>Vigencia:</strong> A partir del 6 de noviembre de 2025
        </p>

        <hr className="mb-8 border-neutral-300 dark:border-neutral-600" />

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">1. Introducción</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">2. Información que Recopilamos</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">2.1 Información que Usted nos Proporciona Directamente</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
            Recopilamos la siguiente información cuando se registra y utiliza nuestros servicios:
          </p>

          <div className="ml-4 mb-4">
            <h4 className="font-semibold text-gray-800 dark:text-neutral-200 mb-2">Información de Cuenta:</h4>
            <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
          ...
          <div className="ml-4 mb-4">
            <h4 className="font-semibold text-gray-800 dark:text-neutral-200 mb-2">Información de Propiedades (Solo Anfitriones):</h4>
            <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
          ...
          <div className="ml-4 mb-4">
            <h4 className="font-semibold text-gray-800 dark:text-neutral-200 mb-2">Información de Reservas:</h4>
            <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
          ...
          <div className="ml-4 mb-4">
            <h4 className="font-semibold text-gray-800 dark:text-neutral-200 mb-2">Información de Pago:</h4>
            <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3 mt-6">2.2 Información Recopilada Automáticamente</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">Cuando utiliza la Aplicación, podemos recopilar automáticamente:</p>
          <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3 mt-6">2.3 Información que NO Recopilamos</h3>
          <ul className="list-none ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">3. Cómo Utilizamos su Información</h2>

          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">3.1 Prestación de Servicios</h3>
              <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">3.2 Mejora de la Aplicación</h3>
              <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">3.3 Comunicaciones</h3>
              <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">3.4 Seguridad y Cumplimiento Legal</h3>
              <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">7.1 Derecho de Acceso</h3>
              <p className="text-gray-700 dark:text-neutral-300">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">7.2 Derecho de Rectificación</h3>
              <p className="text-gray-700 dark:text-neutral-300">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">7.3 Derecho de Eliminación ("Derecho al Olvido")</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">7.7 Cómo Ejercer sus Derechos</h3>
              <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">8. Privacidad de Menores de Edad</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">8.1 Menores de 13 Años</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">8.2 Menores entre 13 y 17 Años</h3>
          <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-2 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">8.3 Si Usted es Padre o Tutor</h3>
          <p className="text-gray-700 dark:text-neutral-300">
            Si cree que su hijo menor de 13 años nos ha proporcionado información personal,
            contáctenos inmediatamente a <a href="mailto:maridimas08@gmail.com" className="text-primary-600 dark:text-primary-400 hover:underline">maridimas08@gmail.com</a> y
            eliminaremos esa información.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">14. Información de Contacto</h2>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border-2 border-blue-200 dark:border-blue-700 p-6 rounded-lg">
            <p className="font-bold text-gray-800 dark:text-neutral-100 mb-4 text-lg">Arroyo Seco Booking - Xi'lúm</p>
            <ul className="space-y-3 text-gray-700 dark:text-neutral-300">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:maridimas08@gmail.com" className="text-primary-600 dark:text-primary-400 hover:underline font-semibold">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+524428139975" className="text-primary-600 dark:text-primary-400 hover:underline font-semibold">
                    +52 442 813 9975
                  </a>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="https://xilmq.com" className="text-primary-600 dark:text-primary-400 hover:underline">https://xilmq.com</a>
                </div>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Resumen en Términos Simples</h2>

          <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-primary-600 dark:border-primary-500 p-4 space-y-3">
            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Qué información recopilamos?</p>
              <p className="text-gray-700 dark:text-neutral-300">Su nombre, email, teléfono, información de reservas y pagos (procesados por Stripe).</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Cómo la usamos?</p>
              <p className="text-gray-700 dark:text-neutral-300">Para procesar reservas, conectar huéspedes con anfitriones, y mejorar la aplicación.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Con quién la compartimos?</p>
              <p className="text-gray-700 dark:text-neutral-300">Solo con anfitriones/huéspedes para reservas, Stripe para pagos, y Firebase/Google Cloud para almacenamiento. <strong>Nunca vendemos sus datos.</strong></p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Cómo la protegemos?</p>
              <p className="text-gray-700 dark:text-neutral-300">Encriptación HTTPS, contraseñas hasheadas, autenticación segura.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Cuáles son sus derechos?</p>
              <p className="text-gray-700 dark:text-neutral-300">Puede acceder, corregir, eliminar o exportar sus datos en cualquier momento.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Menores de edad?</p>
              <p className="text-gray-700 dark:text-neutral-300">No aceptamos usuarios menores de 13 años. Usuarios de 13-17 requieren supervisión parental.</p>
            </div>
          </div>
        </section>
