    ...
    <div className="bg-gray-50 dark:bg-neutral-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-8">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Introducción y Descripción del Servicio</h2>
          <p className="text-gray-700 dark:text-neutral-300 dark:text-neutral-300 mb-4">
            <strong>Xi'lúm</strong>, en adelante la "Aplicación" o "Plataforma", les da la bienvenida a nuestro
            portal <a href="https://xilmq.com" className="text-primary-600 dark:text-primary-400 hover:underline">https://xilmq.com</a> y
          ...
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
            ...
            <Link to="/privacy-policy" className="text-primary-600 dark:text-primary-400 hover:underline">Política de Privacidad</Link>,
            y acepta estar sujeto a ellos.
          </p>
          <p className="text-gray-700 dark:text-neutral-300 font-semibold">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">1. Aceptación de los Términos</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">Requisitos de edad:</h3>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">2. Descripción del Servicio</h2>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">Nuestra función:</h3>
          <ul className="list-disc ml-6 text-gray-700 dark:text-neutral-300 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">3. Registro y Cuentas</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">3.1 Creación de Cuenta</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">Para utilizar nuestros servicios completos, debe crear una cuenta proporcionando:</p>
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">3.2 Responsabilidades del Usuario</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-2">Al crear una cuenta, usted acepta:</p>
          <ul className="list-none ml-6 text-gray-700 dark:text-neutral-300 space-y-1 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">7. Políticas de Cancelación</h2>

          <div className="bg-amber-50 dark:bg-amber-900/30 border-l-4 border-amber-500 dark:border-amber-600 p-4 mb-4">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-neutral-200 mb-3">Plazos de cancelación:</h3>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">10. Privacidad y Protección de Datos</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">10.1 Información Compartida</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
          ...
          <div className="space-y-3">
            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">a) Proveedores de Pago (Stripe)</p>
            ...
            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">b) Servicios de Almacenamiento (Firebase/Google Cloud)</p>
              <p className="text-gray-700 dark:text-neutral-300">
            ...
            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">c) Administración Municipal</p>
              <p className="text-gray-700 dark:text-neutral-300">
          ...
          <p className="text-gray-700 dark:text-neutral-300 mt-4">
            ...
            <Link to="/privacy-policy" className="text-primary-600 dark:text-primary-400 hover:underline font-semibold">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">15. Eliminación de Cuenta</h2>

          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3">15.1 Cómo Solicitar la Eliminación</h3>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
          ...
          <div className="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 dark:border-red-600 p-4">
            <p className="text-gray-700 dark:text-neutral-300 mb-2">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-3 mt-4">15.3 Retención de Datos Legales</h3>
          <p className="text-gray-700 dark:text-neutral-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Información de Contacto</h2>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
        ...
        <section className="mb-8">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-primary-600 dark:border-primary-500 p-4 space-y-3">
            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Quién puede usar Xi'lúm?</p>
              <p className="text-gray-700 dark:text-neutral-300">Usuarios mayores de 13 años. Los menores de 18 requieren supervisión parental.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Qué hace Xi'lúm?</p>
              <p className="text-gray-700 dark:text-neutral-300">Conecta huéspedes con anfitriones en Arroyo Seco y procesa pagos de forma segura.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Puedo cancelar una reserva?</p>
              <p className="text-gray-700 dark:text-neutral-300">Sí, pero el reembolso depende de cuánto tiempo falte para el check-in (ver políticas de cancelación).</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Cómo elimino mi cuenta?</p>
              <p className="text-gray-700 dark:text-neutral-300">Ve a Configuración → Mi Perfil y solicita la eliminación. La procesaremos en 30 días.</p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-neutral-200">¿Mis datos están seguros?</p>
              <p className="text-gray-700 dark:text-neutral-300">Sí, usamos encriptación HTTPS, Stripe para pagos, y cumplimos con GDPR y leyes mexicanas.</p>
            </div>
          </div>
        </section>
