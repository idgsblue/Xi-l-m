  ...
  return (
    <div className="min-h-screen bg-primary-50 py-12">
      <div className="container-custom max-w-4xl">
        <h1 className="heading-1 text-neutral-900 mb-8">
        ...
        <div className="card mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-lg text-neutral-900">{user?.full_name || user?.name}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-neutral-900">{user?.phone || 'No proporcionado'}</p>
            </div>
            ...
            <div>
              ...
              <span className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${
                user?.role === 'host' ? 'bg-accent-100 text-accent-800' :
        ...
        <div className="card mb-8">
          ...
          <div className="space-y-4 bg-primary-50 p-6 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 mb-1">Correo Electrónico</h3>
                <a href="mailto:maridimas08@gmail.com" className="text-primary-600 hover:text-primary-700 font-medium">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+524428139975" className="text-primary-600 hover:text-primary-700 font-medium">
                  +52 442 813 9975
                </a>
              </div>
            </div>
        ...
        <div className="card mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start pt-4 border-t border-neutral-200">
              <div className="flex-1">
                <h3 className="font-semibold text-neutral-900 mb-2">
        ...
        <div className="card border-2 border-error-200 bg-error-50">
          <h2 className="text-2xl font-bold text-error-700 mb-4">
            Zona de Peligro
          </h2>

          <div className="bg-white rounded-lg p-6 border border-error-200">
            <h3 className="font-semibold text-neutral-900 mb-2">
        ...
        {showDeleteModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-md w-full p-6">
              <h3 className="text-xl font-bold text-error-700 mb-4">
                Solicitar Eliminación de Cuenta
              </h3>
              ...
              <form onSubmit={handleRequestAccountDeletion}>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-6 py-2 border border-neutral-300 rounded-lg font-medium text-neutral-700 hover:bg-neutral-50 transition-colors"
                    disabled={isSending}
                  >
                    Cancelar
                  </button>
              ...
              <div className="mt-4 pt-4 border-t border-neutral-200">
                <p className="text-xs text-neutral-600 text-center">
                  ...
                  <a href="mailto:maridimas08@gmail.com" className="text-primary-600 hover:underline font-medium">
                    maridimas08@gmail.com
                  </a>
                </p>
              </div>
