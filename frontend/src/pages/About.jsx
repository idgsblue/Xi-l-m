    ...
    <div className="bg-gray-50 dark:bg-neutral-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-8">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Nuestra Historia</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">¿Qué Ofrecemos?</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Para Viajeros</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-neutral-300 space-y-2 ml-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Para Anfitriones</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-neutral-300 space-y-2 ml-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Nuestros Valores</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-primary-50 dark:bg-neutral-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Turismo Sostenible</h3>
            ...
            <div className="bg-primary-50 dark:bg-neutral-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Comunidad Local</h3>
              <p className="text-gray-700 dark:text-neutral-300">
            ...
            <div className="bg-primary-50 dark:bg-neutral-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Confianza y Seguridad</h3>
              <p className="text-gray-700 dark:text-neutral-300">
            ...
            <div className="bg-primary-50 dark:bg-neutral-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-200 mb-2">Experiencias Auténticas</h3>
              <p className="text-gray-700 dark:text-neutral-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-neutral-200 mb-4">Desarrollo del Proyecto</h2>
          <p className="text-gray-700 dark:text-neutral-300 mb-4">
