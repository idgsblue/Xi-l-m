      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-6">
            {/* Teléfono */}
            <div className="flex items-start space-x-4 p-6 bg-primary-50 rounded-lg hover:bg-primary-100 transition-colors">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-secondary-500 pl-4">
              <h3 className="font-semibold text-gray-800 mb-2">¿Cómo puedo reservar un alojamiento?</h3>
              <p className="text-gray-700">
            ...
            <div className="border-l-4 border-secondary-500 pl-4">
              <h3 className="font-semibold text-gray-800 mb-2">¿Cómo me convierto en anfitrión?</h3>
              <p className="text-gray-700">
            ...
            <div className="border-l-4 border-secondary-500 pl-4">
              <h3 className="font-semibold text-gray-800 mb-2">¿Cuál es la política de cancelación?</h3>
              <p className="text-gray-700">
                Consulta nuestra{' '}
            ...
            <div className="border-l-4 border-secondary-500 pl-4">
              <h3 className="font-semibold text-gray-800 mb-2">¿Mis datos están seguros?</h3>
              <p className="text-gray-700">
